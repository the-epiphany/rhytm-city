...
class Building:
    ...
    def play(self, any_solo):
        """Воспроизводит звук."""
        # Если есть соло и это не я - не играю
...
class Sequencer:
    ...
    def __init__(self, bpm):
        ...
        # Вычисляем, сколько времени занимает один шаг
    ...
    def update(self, dt):
        ...
        if self.timer >= self.step_time:
            ...
            return True  # Сообщаем, что наступил новый шаг
...
class Game:
    ...
    def next_level(self):
        ...
        if self.current_level_index >= len(LEVELS):
            ...
            self.current_level_index = len(LEVELS) - 1  # Остаёмся на последнем
            return
    ...
    def check_level_goals(self):
        ...
        # Проверяем сколько тактов проиграли
    ...
    def calculate_rms(self):
        ...
        # Суммируем громкости всех незаглушенных зданий
        total = 0.0
        count = 0
    ...
    def handle_events(self):
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                # Левая кнопка
                if event.button == 1:
                    # Сначала проверяем, не кликнули ли по редактору
    ...
    def update(self):
        ...
        # Обновляем секвенсер (проверяем, не пора ли следующий шаг)
        new_step = self.sequencer.update(dt)

        # Если наступил новый шаг - воспроизводим звуки
        if new_step:
            self.play_step()
